...
from proc_planner_ros2.TrajectoryGenerator2 import TrajectoryGenerator
...
def test_traj_gen_init(generated_dummy_geoNode, generated_dummy_soniaNode, generated_ros_params):
    ...
    traj_gen2 = TrajectoryGenerator2(
        generated_dummy_soniaNode, generated_dummy_geoNode, generated_ros_params, logger_node.get_logger()
    )
...
def test_traj_gen_compute(expected_traj_data, generated_dummy_geoNode, generated_dummy_soniaNode, generated_ros_params):
    ...
    for i in range(len(expected_traj_data.transforms)):
        assert np.round(actual_out.transforms[i].translation.x, 10) == np.round(expected_traj_data.transforms[i].translation.x, 10)
        assert np.round(actual_out.transforms[i].translation.y, 10) == np.round(expected_traj_data.transforms[i].translation.y, 10)
        assert np.round(actual_out.transforms[i].translation.z, 10) == np.round(expected_traj_data.transforms[i].translation.z, 10)
        assert np.round(actual_out.transforms[i].rotation.x, 10) == np.round(expected_traj_data.transforms[i].rotation.x, 10)
        assert np.round(actual_out.transforms[i].rotation.y, 10) == np.round(expected_traj_data.transforms[i].rotation.y, 10)
        assert np.round(actual_out.transforms[i].rotation.z, 10) == np.round(expected_traj_data.transforms[i].rotation.z, 10)
        assert np.round(actual_out.transforms[i].rotation.w, 10) == np.round(expected_traj_data.transforms[i].rotation.w, 10)

        assert np.round(actual_out.velocities[i].linear.x, 10) == np.round(expected_traj_data.velocities[i].linear.x, 10)
        assert np.round(actual_out.velocities[i].linear.y, 10) == np.round(expected_traj_data.velocities[i].linear.y, 10)
        assert np.round(actual_out.velocities[i].linear.z, 10) == np.round(expected_traj_data.velocities[i].linear.z, 10)
        assert np.round(actual_out.velocities[i].angular.x, 10) == np.round(expected_traj_data.velocities[i].angular.x, 10)
        assert np.round(actual_out.velocities[i].angular.y, 10) == np.round(expected_traj_data.velocities[i].angular.y, 10)
        assert np.round(actual_out.velocities[i].angular.z, 10) == np.round(expected_traj_data.velocities[i].angular.z, 10)

        assert np.round(actual_out.accelerations[i].linear.x, 10) == np.round(expected_traj_data.accelerations[i].linear.x, 10)
        assert np.round(actual_out.accelerations[i].linear.y, 10) == np.round(expected_traj_data.accelerations[i].linear.y, 10)
        assert np.round(actual_out.accelerations[i].linear.z, 10) == np.round(expected_traj_data.accelerations[i].linear.z, 10)
        assert np.round(actual_out.accelerations[i].angular.x, 10) == np.round(expected_traj_data.accelerations[i].angular.x, 10)
        assert np.round(actual_out.accelerations[i].angular.y, 10) == np.round(expected_traj_data.accelerations[i].angular.y, 10)
        assert np.round(actual_out.accelerations[i].angular.z, 10) == np.round(expected_traj_data.accelerations[i].angular.z, 10)